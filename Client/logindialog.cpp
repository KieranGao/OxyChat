    ...
    ui(new Ui::LoginDialog)
{
    ...
    connect(TCPManager::getInstance().get(), &TCPManager::signal_connect_success, this, &LoginDialog::slot_tcp_connect_finish);
...
void LoginDialog::initHttpHandlers() {
    ...
    handlers_.insert(ReqId::ID_USER_LOGIN, [this](QJsonObject jsonObj){
        ...
        if(error != ErrorCodes::SUCCESS){
            ErrorContent(tr("===Email or password may be wrong!==="));
            return;
        }
