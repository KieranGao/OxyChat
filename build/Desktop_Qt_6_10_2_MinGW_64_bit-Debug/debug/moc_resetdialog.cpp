...
void ResetDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (ResetDialog::*)()>(_a, &ResetDialog::CancelToLogin, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (ResetDialog::*)()>(_a, &ResetDialog::ConfirmToLogin, 1))
            return;
    }
}
...
// SIGNAL 0
void ResetDialog::CancelToLogin()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void ResetDialog::ConfirmToLogin()
{
